...
from ApiFramework.conf.config import AddToCartUrl
from ApiFramework.public.get_cookie import get_cookie
from ApiFramework.public.get_goods_id import get_gid
...
class AddToCart(unittest.TestCase):
    ...
    @yaml_data(r"D:\PythonProject\109\ApiFramework\data\add_to_cart.yaml")
